...
public class AudioHandler {
     ...
     * @param listener the audio data listener for the new audio data
     * @throws gong.audio.AudioHandlerException failed to download the data
     */
    public void downloadData(File cache, boolean synchronous, AudioDataListener listener) throws AudioHandlerException {
        if (audioData == null && !hasData()) throw new AudioHandlerException("Failed to download empty URL.");
        ...
        if (audioData != null) {
            ...
            try {
                ...
                audioData.setListener(listener);
     ...
     * @throws gong.audio.AudioHandlerException failed to download the data
     */
    public void downloadData(File cache, boolean synchronous) throws AudioHandlerException {
        downloadData(cache, synchronous, null);
    }
     ...
     * @throws gong.audio.AudioHandlerException failed to start recording
     */
    public synchronized void record(long timeToStop) throws AudioHandlerException {
        if (recorder == null) {
    ...
    protected class Player extends Thread {
         ...
         * @throws gong.audio.AudioHandlerException failed to open the player
         */
        public void open() throws AudioHandlerException {
            Info info = new Info(SourceDataLine.class, targetFormat);
            if (!AudioSystem.isLineSupported(info)) throw new AudioHandlerException("Failed to initialize audio player.");
     ...
     * @throws gong.audio.AudioHandlerException failed to play the media
     */
    public synchronized void play(long startTime, long timeToStop) throws AudioHandlerException {
        if (player == null) {
            try {
     ...
     * @throws gong.audio.AudioHandlerException failed to play the media
     */
    public synchronized void play(long startTime) throws AudioHandlerException {
        play(startTime, 0);
    }
     ...
     * @throws gong.audio.AudioHandlerException failed to stop the audio handler
     */
     ...
     * @throws gong.audio.AudioHandlerException failed to close the audio handler
     */
