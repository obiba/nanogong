...
public abstract class ScriptHandler {
    ...
    protected void executeRequest() {
        try {
            ...
            if (name.equals("PlayMediaRequest"))
                ...
                stopMedia();
            else if (name.equals("ClearMediaRequest"))
                clearMedia();
            else if (name.equals("SetMediaTimeRequest"))
                setMediaTime();
    ...
    /**
     * Clears the current media
     * @throws java.lang.Exception failed to clear the media
     */
